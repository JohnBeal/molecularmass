...
[Relative molecular mass] (http://goldbook.iupac.org/R05271.html) is an important characteristic of molecular chemical compounds. It is defined as the ratio of the mass of a molecule to the [unified atomic mass unit] (http://goldbook.iupac.org/U06554.html). Its units are defined as \(\frac{1}{12}\)th the mass of a <sup>12</sup>C atom.
...
Molecular mass is calculated as the sum of the product of the atomic mass of the element and number of atoms of the element in the molecule; for each element in the moelecule. 
...
Example for ATP (adeosine triphosphate, C<sub>10</sub>H<sub>16</sub>N<sub>5</sub>O<sub>13</sub>P<sub>3</sub>):
